    ...
    <div class="flex justify-center items-center h-screen">
        <div class="bg-white p-8 rounded shadow-md w-96">
            ...
            <form id="forgotPasswordForm" style="display: none;" class="slide-in" action="forgot.php" method="POST">
                ...
                <div class="mb-4">
                    <label for="email" class="block text-gray-700 text-sm font-bold mb-2">Correo electrónico:</label>
                    <input type="email" id="email" name="email" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" value="" pattern="[a-zA-Z0-9]+([.][a-zA-Z0-9]+)*@[a-zA-Z0-9]+\.[a-zA-Z]{2,4}(\.[a-zA-Z]{2})?" required>
                </div>
                <div class="flex justify-between items-center mb-4">
                    <a href="#" class="text-blue-500 hover:underline" onclick="showLoginForm()">Iniciar sesión</a>
                </div>
                <button type="submit" name="send" class="w-full bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Recuperar contraseña</button>
            </form>
        </div>
    </div>
